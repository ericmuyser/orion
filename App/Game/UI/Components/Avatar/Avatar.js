    ...
    render() {
            ...
            otherElements = (
                <View style={styles.otherCharacterChooser}>
                    {otherCharacters.map((key) => {
                        return <View style={{width: 32, height: 32, marginBottom: 10, background: 'transparent url("/Game/Assets/GFX/Characters/' + key + '/walkDown-0002.png") no-repeat 0 0'}} onClick={()=>this.changeCharacter(key)}></View>;
                    })}
                </View>
            );
        }
        ...
        return (
            <View style={styles.container}>
                <View style={{width: 32, height: 32, background: '#01242C url("/Game/Assets/GFX/Characters/' + this.props.currentCharacter + '/walkDown-0002.png") no-repeat 0 0'}} onClick={this.clickCharacter}></View>
