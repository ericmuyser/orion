        ...
        constructor() {
            ...
            this.stateHandler.prototype = {
                preload: function(gam) {
                    OrionV1.game.engine.load.image('chunk', 'Assets/tmp/chunk.png');
                    OrionV1.game.engine.load.image('arrow', 'Assets/tmp/asteroids_ship.png');
                },
                create: function(gam) {
                    function launch() {
...
RPG:
    ...
    return;
    var OrionV1 = {};
    OrionV1.GAME_WIDTH = 800; // Game originally designed for 800px
    OrionV1.GAME_HEIGHT = 800; // Game originally designed for 800px
    ...
    class IngameState extends React.Component {
        constructor() {
            ...
            this.stateHandler.prototype = {
                ...
                render: function() { // what are the args here?
                },
    ...
    class StartState extends React.Component {
        constructor() {
            ...
            this.stateHandler.prototype.create = function() {
                ...
                OrionV1.game.engine.stage.setBackgroundColor(0x2d2d2d);
    ...
    class AwesomeGame extends React.Component {
        ...
        render() {
            return (
                <View style={{'position': 'relative', 'width': '800px'}}>
                    <Game {...props3} key="d" onInit={this.onInit}>
                        {this.z === 'preload' && <PreloadState onLoad={this.onLoad} />}
                        {this.z === 'start' && <StartState onStart={this.onStart} />}
                        {this.z === 'ingame' && <IngameState />}
                    </Game>
